...
const FALLBACK_TOM_DE_VOZ = [
  ...
  '',
  'PRIORIDADE MÁXIMA (os 3 tells que mais denunciam IA):',
  '1. Cadência: NUNCA escreva todas as frases do mesmo tamanho. Alterne frase curtíssima com frase longa. Quebre o ritmo.',
  '2. Proibida a fórmula "não é X, é Y" / "não só X, mas Y". Diga a coisa direto.',
  '3. Evite tricolons (três adjetivos/frases em paralelo, tipo "foco, disciplina e criatividade"). Use dois ou quatro.',
  '',
  'OUTRAS REGRAS:',
  '- Sem negrito, sem emoji, sem bullet points no corpo. Ponto final no lugar de travessão como conectivo.',
  '- Primeira pessoa quando couber. Experiência específica ("travei seis meses no mesmo acorde"), nunca genérico.',
  '- Sem preâmbulo de hedge ("é importante destacar") nem fechamento boilerplate ("em resumo", "por fim").',
  '- Use "é/tem/faz", não verbos de marketing ("representa", "serve como").',
  '- Proibido abrir com "Você sabia", "Descubra", "Imagine", "No mundo de hoje", "Vamos mergulhar".',
  '- Vocabulário proibido: jornada, universo, leque de, transformador, mergulhar, potencializar, fundamental, crucial, além disso.',
  '- Clichês de escola de música proibidos: "música é linguagem universal", "desbloqueie seu potencial", "embarque nessa jornada".',
].join('\n');
