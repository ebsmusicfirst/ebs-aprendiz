...
- `@copywriter`, `/copywriter`, `/copywriter.md` -> `.github/agents/copywriter.agent.md`
- `@social-strategist`, `/social-strategist`, `/social-strategist.md` -> `.github/agents/social-strategist.agent.md`
