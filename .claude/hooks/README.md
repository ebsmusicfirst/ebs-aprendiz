...
|------|--------|---------|-----------|
| `session-start-context.cjs` | `SessionStart` | — | Injeta INDEX + handoff mais recente + queue state no início de toda sessão |
...
| `post-dashboard-test.cjs` | `PostToolUse` | `Edit\|Write` | Auto-roda smoke test após editar scripts/dashboard.js |
